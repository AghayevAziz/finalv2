...
<br><br><br>
	<div id="form">	
		...
		<div class="col-md-12" id ="mainform">
			...
			<div class="col-sm-6" >
				<form method="POST">
				<label><h4>Name:</h4> </label><input type="text" name="name"  class=" form-control" placeholder="User name" required />
				<label><h4>Email:</h4></label> <input type="email" name="email"  class=" form-control" placeholder="User Email" required/>
