...
<body  background=images/contus.jpg>
<style>
...
<?php 
    ...
    if(isset($_POST['book'])){
        ...
        if(empty($bplace)|| empty($bdate)|| empty($dur)|| empty($phno)|| empty($des)){
            ...
            $price=($dur*$carprice);
            $sql="insert into booking (CAR_ID,EMAIL,BOOK_PLACE,BOOK_DATE,DURATION,PHONE_NUMBER,DESTINATION,PRICE) values($carid,'$uemail','$bplace','$bdate',$dur,$phno,'$des',$price)";
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            ...
            id="datefield"   placeholder="ENTER THE DATE FOR BOOKING">
            <br><br>
